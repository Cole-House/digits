      ...
      <div className={'digits-landing-background'}>
        <Grid container centered stackable columns={3}>
          ...
          <Grid.Column textAlign={'center'}>
            ...
            <Header as={'h3'} inverted>This address book enables any number of users to register and save their business contacts. You can only see the contacts you created on your account.</Header>
          </Grid.Column>

          <Grid.Column textAlign={'center'}>
            <Icon size={'huge'} name={'file alternate'} inverted/>
            <Header as={'h1'} inverted> Contact Details </Header>
            <Header as={'h3'} inverted>For each address you can save their name, address, and phone number.</Header>
          </Grid.Column>
